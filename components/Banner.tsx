...
export const HONESTY_TEXT =
  "Educational concept — not affiliated with BPM or the AICPA. Company, controls, evidence, and access data are synthetic. Not an official SOC 2 assessment or opinion.";
    ...
    <div className="w-full border-b border-amber-200 bg-amber-50 px-4 py-2 text-amber-900">
      <div className="mx-auto flex max-w-[1600px] items-start gap-2 text-[12px] leading-5">
        ...
        <p>
          ...
          affiliated with BPM or the AICPA. Company, controls, evidence, and
          access data are synthetic. Not an official SOC 2 assessment or
          opinion.
        </p>
      </div>
    </div>
